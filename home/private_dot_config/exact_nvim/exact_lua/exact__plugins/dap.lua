...
vim.keymap.set("n", "<leader>dt", function() require("dap").toggle_breakpoint() end, { nowait = true, noremap = true, silent = true, desc = "Breakpoint Toggle" })
...
-- stylua: ignore start
vim.keymap.set("n", "<localleader>do", "<cmd>DapViewOpen<cr>", { noremap = true, silent = true, desc = "DapViewOpen" })
vim.keymap.set("n", "<localleader>dc", "<cmd>DapViewClose<cr>", { noremap = true, silent = true, desc = "DapViewClose" })
-- stylua: ignore end
