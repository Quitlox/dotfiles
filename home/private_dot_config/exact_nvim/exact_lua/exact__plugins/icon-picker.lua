...
require("_config.util.lazy").command_stub_args("IconPickerNormal", setup_icon_picker)
require("_config.util.lazy").command_stub_args("IconPickerInsert", setup_icon_picker)
require("_config.util.lazy").command_stub_args("IconPickerYank", setup_icon_picker)
