...
vim.keymap.set("n", "<leader>dd", function()
    require("dap").continue()
end, { noremap = true, silent = true, desc = "Debugger Launch/Continue" })
...
end, { noremap = true, silent = true, desc = "Breakpoint Toggle" })
vim.keymap.set("n", "<leader>dbm", function()
    require("dap").set_breakpoint(nil, nil, vim.fn.input("Log point message: "))
end, { noremap = true, silent = true, desc = "Breakpoint Message" })
vim.keymap.set("n", "<leader>dbc", function()
    require("dap").toggle_breakpoint(vim.fn.input("Condition: "))
end, { noremap = true, silent = true, desc = "Breakpoint Condition" })
