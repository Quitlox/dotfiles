...
local function set_keybindings(bufnr)
    ...
    vim.keymap.set("n", "[d", function() vim.diagnostic.goto_prev({ float = false, severity = { min = vim.diagnostic.severity.INFO } }) end, { desc = "Prev Diagnostic", buffer = bufnr, silent = true, noremap = true })
    vim.keymap.set("n", "]d", function() vim.diagnostic.goto_next({ float = false, severity = { min = vim.diagnostic.severity.INFO } }) end, { desc = "Next Diagnostic", buffer = bufnr, silent = true, noremap = true })
    vim.keymap.set("n", "[w", function() vim.diagnostic.goto_prev({ float = false, severity = { min = vim.diagnostic.severity.WARN } }) end, { desc = "Prev Diagnostic", buffer = bufnr, silent = true, noremap = true })
    vim.keymap.set("n", "]w", function() vim.diagnostic.goto_next({ float = false, severity = { min = vim.diagnostic.severity.WARN } }) end, { desc = "Next Diagnostic", buffer = bufnr, silent = true, noremap = true })
    vim.keymap.set("n", "[e", function() vim.diagnostic.goto_prev({ float = false, severity = vim.diagnostic.severity.ERROR }) end, { desc = "Prev Error", buffer = bufnr, silent = true, noremap = true })
    vim.keymap.set("n", "]e", function() vim.diagnostic.goto_next({ float = false, severity = vim.diagnostic.severity.ERROR }) end, { desc = "Prev Error", buffer = bufnr, silent = true, noremap = true })
    ...
    -- stylua: ignore end
    vim.keymap.set("n", "g<Enter>", "<cmd>lua require('fastaction').code_action()<cr>", { buffer = bufnr })
    vim.keymap.set("v", "g<Enter>", "<cmd>lua require('fastaction').range_code_action()<cr>", { buffer = bufnr })
